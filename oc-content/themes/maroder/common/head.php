...
<?php
    $js_lang = array(
        'delete' => __('Delete', 'maroder'),
        'cancel' => __('Cancel', 'maroder')
    );
    ...
    osc_register_script('bootstrap-js', osc_current_web_theme_js_url('bootstrap/dist/js/bootstrap.js'),
		'jquery');
...
<script>
    var maroder = window.maroder || {};
    maroder.base_url = '<?php echo osc_base_url(true); ?>';
    maroder.langs = <?php echo json_encode($js_lang); ?>;
    maroder.fancybox_prev = '<?php echo osc_esc_js( __('Previous image','maroder')) ?>';
    maroder.fancybox_next = '<?php echo osc_esc_js( __('Next image','maroder')) ?>';
    maroder.fancybox_closeBtn = '<?php echo osc_esc_js( __('Close','maroder')) ?>';
</script>
<link href="<?php echo osc_current_web_theme_url
('css/bootstrap/css/bootstrap.css') ; ?>" rel="stylesheet" type="text/css" />
